    ...
    return (
        <div>
            <div className="min-w-mobile   flex w-mobile justify-center gap-6  py-2">
                <div className="border-slate-300 flex flex-wrap rounded-xl border-2">
                    ...
                    <Combobox value={book} onChange={setBook}>
                        ...
                        />
                        <div className=" max-h-25 bottom bg-green-300 absolute   top-[100px] w-mobile overflow-auto border-l-2 ">
                            <Combobox.Options value={book} onChange={setBook}>
                                {filteredBooks.map((searchedBook) => (
                                    <Combobox.Option
                                        onSelect={(searchedBook) =>
                    ...
                    <Combobox value={zipCode} onChange={setZipCode}>
                        <div className="relative border-l-2">
                            ...
                            />
                            <div className=" right bg-green-300 absolute  max-h-24  flex-col overflow-auto border-l-2 ">
                                <Combobox.Options>
                                    {filteredZip.map((zip) => (
                                        <Combobox.Option
                ...
                <div>
                    <div id="search-form-button" className="">
                        <button
                            type="button"
                            className="    border-slate-200 text-slate-400  rounded-lg  border-2 bg-white p-2 outline-none"
                        >
                        ...
                        <form
                            className={clsx(
                                isActive
                                    ? "opacity-100"
                                    : "invisible opacity-0 ",
                                "border-gray-400  absolute flex transform  flex-col rounded-lg border-2 bg-white py-2 px-4 text-start text-sm font-medium text-black  duration-500"
                            )}
                        >
